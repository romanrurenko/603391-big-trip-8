...
/* harmony import */ var _models_events__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../models/events */ "./src/models/events.js");
/* harmony import */ var _models_offers__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../models/offers */ "./src/models/offers.js");
...
const Api = class {
  ...
  createEvent({
    ...
    }).then(toJSON).then(_models_events__WEBPACK_IMPORTED_MODULE_0__["ModelEvent"].parseEvent);
  }
...
/* harmony import */ var _data_mock_data__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../data/mock-data */ "./src/data/mock-data.js");
...
class EventEdit extends _component__WEBPACK_IMPORTED_MODULE_0__["Component"] {
  constructor(data, destinationsData, offersData) {
    super();
    this._id = data.id;
    ...
    this._totalPrice = Object(_utils__WEBPACK_IMPORTED_MODULE_3__["getElementPrice"])(data.offers, data.price);
  ...
  _changeOffers(newOffer) {
    for (let it of this._offersData) {
      if (it.type === newOffer) {
  ...
  _onChangeDescription(evt) {
    ...
    for (const it of this._destinations) {
  ...
  _onTravelClick(evt) {
    ...
    if (newTravelType && _data_mock_data__WEBPACK_IMPORTED_MODULE_2__["travelType"].indexOf(newTravelType) > -1) {
        ...
        <form class="event__form" method="get">
          ...
          <label class="point__date">
            ...
            <div class="travel-way">
              <label class="travel-way__label" for="travel-way__toggle-${this._id}">${_data_mock_data__WEBPACK_IMPORTED_MODULE_2__["travelToData"][this._type].icon}</label>
              ...
              <div class="travel-way__select">
                <div class="travel-way__select-group">
                        ...
                        ${Array.from(_data_mock_data__WEBPACK_IMPORTED_MODULE_2__["travelType"]).map(it => `
                  ...
                  ${_data_mock_data__WEBPACK_IMPORTED_MODULE_2__["travelToData"][it].icon} ${it}</label>`.trim()).join(``)}
            ...
            <div class="point__destination-wrap">
              <label class="point__destination-label" for="destination">${_data_mock_data__WEBPACK_IMPORTED_MODULE_2__["travelToData"][this._type].text}</label>
              <input class="point__destination-input" list="destination-select" id="destination" value="${this._city}" name="destination">
              <datalist id="destination-select">



               ${this._destinations.map(it => `<option value="${it.name}"></option>`.trim()).join(``)}
            ...
            <div class="point__time">
              choose time
              <input class="point__input" id="date-start" type="text" value="${Object(_main__WEBPACK_IMPORTED_MODULE_1__["moment"])(this._dateFrom)}" name="date-start" placeholder="19:00">
              <input class="point__input" id="date-end"  type="text" value="${Object(_main__WEBPACK_IMPORTED_MODULE_1__["moment"])(this._dateTo)}" name="date-end" placeholder="21:00">
            </div>
  ...
  bind() {
    this._element.querySelector(`.point__destination-input`).addEventListener(`change`, this._onChangeDescription);

    this._element.addEventListener(`keydown`, this._onEscPress);

    this._element.querySelector(`.travel-way__select`).addEventListener(`click`, this._onTravelClick);

    this._element.querySelector(`.event__form`).addEventListener(`submit`, this._onSubmitButtonClick);

    this._element.querySelector(`.delete`).addEventListener(`click`, this._onDeleteClick);

    this._element.querySelector(`.point__favorite`).addEventListener(`click`, this._onChangeFavorite);

    Object(_main__WEBPACK_IMPORTED_MODULE_1__["flatpickr"])(this._element.querySelector(`#date-start`), {
      ...
      altFormat: `H:i`,
      onChange: data => {
        this._dateFrom = data.toString();
      }
    });
    Object(_main__WEBPACK_IMPORTED_MODULE_1__["flatpickr"])(this._element.querySelector(`#date-end`), {
  ...
  unbind() {
    ...
    this._element.querySelector(`.delete`).removeEventListener(`click`, this._onDeleteClick);

    this._element.querySelector(`.point__favorite`).removeEventListener(`click`, this._onChangeFavorite);

    this._element.querySelector(`.point__destination-input`).removeEventListener(`change`, this._onChangeDescription);
  }
...
/* harmony import */ var _component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./component */ "./src/classes/component.js");
/* harmony import */ var _data_mock_data__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../data/mock-data */ "./src/data/mock-data.js");
...
class Event extends _component__WEBPACK_IMPORTED_MODULE_0__["Component"] {
  ...
  get template() {
    const duration = _main__WEBPACK_IMPORTED_MODULE_2__["moment"].duration(Object(_main__WEBPACK_IMPORTED_MODULE_2__["moment"])(this._dateTo).diff(Object(_main__WEBPACK_IMPORTED_MODULE_2__["moment"])(this._dateFrom)));
    const hours = duration.asHours();
    const minutes = duration.asMinutes();
    return `<article class="trip-point">
          <i class="trip-icon">${_data_mock_data__WEBPACK_IMPORTED_MODULE_1__["travelToData"][this._type].icon}</i>
          <h3 class="trip-point__title">${_data_mock_data__WEBPACK_IMPORTED_MODULE_1__["travelToData"][this._type].text} ${this._city}</h3>
          <p class="trip-point__schedule">
            <span class="trip-point__timetable">${Object(_main__WEBPACK_IMPORTED_MODULE_2__["moment"])(this._dateFrom).format(`HH:mm`)} - ${Object(_main__WEBPACK_IMPORTED_MODULE_2__["moment"])(this._dateTo).format(`HH:mm`)}</span>
            <span class="trip-point__duration">${Math.floor(hours)}H ${Math.floor(minutes % 60)}M</span>
          </p>
 ...
 ${offer.title}+&euro;${offer.price}</button></li>` : ``).trim()).join(``)}
  ...
  unbind() {
    this._element.querySelector(`.trip-icon`).removeEventListener(`click`, this._onEditButtonClick);
  }
...
const pointData = () => {
  return {
    ...
    photos: [`http://picsum.photos/100/100?r=${Math.random()}`, `http://picsum.photos/100/100?r=${Object(_utils__WEBPACK_IMPORTED_MODULE_0__["getRandom"])(0, 1000)}`, `http://picsum.photos/100/100?r=${Math.random()}`],
    offers: new Set([`add-luggage`, `switch-to-comfort-class`]),
    dateFrom: new Date(),
    dateTo: Object(_main__WEBPACK_IMPORTED_MODULE_1__["moment"])(new Date()).add(1, `days`).add(10, `minutes`).toDate(),
    totalPrice: 0,
...
/*!*********************!*\
  !*** ./src/main.js ***!
  \*********************/
/*! exports provided: _, filtersContainer, moment, flatpickr, getTotalPrice */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _classes_api__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./classes/api */ "./src/classes/api.js");
/* harmony import */ var _setSwitcher__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./setSwitcher */ "./src/setSwitcher.js");
/* harmony import */ var _models_events__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./models/events */ "./src/models/events.js");
/* harmony import */ var _models_offers__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./models/offers */ "./src/models/offers.js");
...
const api = new _classes_api__WEBPACK_IMPORTED_MODULE_5__["Api"]({
  endPoint: END_POINT,
...
const flatpickr = __webpack_require__(/*! flatpickr */ "./node_modules/flatpickr/dist/flatpickr.js");
const filtersComponents = [];

for (let i = 0; i < _data_mock_data__WEBPACK_IMPORTED_MODULE_1__["filtersData"].length; i++) {
  filtersComponents[i] = new _classes_filter__WEBPACK_IMPORTED_MODULE_4__["Filter"](_data_mock_data__WEBPACK_IMPORTED_MODULE_1__["filtersData"][i]);
  filtersContainer.appendChild(filtersComponents[i].render());

  filtersComponents[i].onFilter = evt => {
    const filterName = evt.target.id;
    const filteredEvents = sortEvents(events, filterName);
    renderPoints(events, eventsContainer);
  };
}
...
const getTotalPrice = data => {
  ...
  for (const it of data) {
    it.totalPrice = Object(_utils__WEBPACK_IMPORTED_MODULE_0__["getElementPrice"])(it.offers, it.price);
...
const renderPoints = (events, destinations, offersData) => {
  eventsContainer.innerHTML = ``;

  for (const event of events) {
    const eventComponent = new _classes_event__WEBPACK_IMPORTED_MODULE_2__["Event"](event);
    const editEventComponent = new _classes_event_edit__WEBPACK_IMPORTED_MODULE_3__["EventEdit"](event, destinations, offersData);

    const block = () => {
      editEventComponent.element.querySelector(`.event__form`).disabled = true;
    };

    const unblock = () => {
      editEventComponent.element.querySelector(`.event__form`).disabled = false;
    };
    ...
    editEventComponent.onDelete = id => {
      ...
      api.deleteEvent(editEventComponent._id).then(unblock()).then(init()).catch(err => {
        console.log(err);
        editEventComponent.shake();
      });
    };
...
const init = () => {
  Promise.all([api.getModelData(`offers`, _models_offers__WEBPACK_IMPORTED_MODULE_8__["ModelOffers"].parseOffers), api.getData(`destinations`), api.getModelData(`points`, _models_events__WEBPACK_IMPORTED_MODULE_7__["ModelEvent"].parseEvents)]).catch(() => {
    console.log(`Error loading data.`);
  }).then(([offersData, destinations, points]) => {
    if (offersData.length && destinations.length && points.length) {
      totalPrice.innerHTML = `€ ${getTotalPrice(points)}`;
      renderPoints(points, destinations, offersData);
    }
  });
};
...
/*!******************************!*\
  !*** ./src/models/events.js ***!
  \******************************/
/*! exports provided: ModelEvent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ModelEvent", function() { return ModelEvent; });
...
/***/ "./src/models/offers.js":
/*!******************************!*\
  !*** ./src/models/offers.js ***!
  \******************************/
/*! exports provided: ModelOffers */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ModelOffers", function() { return ModelOffers; });
class ModelOffers {
  constructor(data) {
...
/*!**********************!*\
  !*** ./src/utils.js ***!
  \**********************/
/*! exports provided: getRandom, clearElement, createElement, getElementPrice */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getElementPrice", function() { return getElementPrice; });
/* harmony import */ var _data_mock_data__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./data/mock-data */ "./src/data/mock-data.js");
...
const getElementPrice = (data, price) => {
  let sum = 0;
