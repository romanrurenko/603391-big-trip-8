 ...
 */
(function (global, factory) {
   true ? module.exports = factory(__webpack_require__(/*! chart.js */ "./node_modules/chart.js/dist/Chart.js")) : undefined;
})(this, function (Chart) {
  'use strict';
...
class Filter extends _component__WEBPACK_IMPORTED_MODULE_0__["Component"] {
  ...
  get template() {
    return `<input type="radio" id="filter-${this._caption.toLowerCase()}"
            ...
            for="filter-${this._caption.toLowerCase()}">${this._caption}</label></input>`.trim();
  }
...
/*!*********************!*\
  !*** ./src/main.js ***!
  \*********************/
/*! exports provided: moment, initialEvents */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _switcher__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./switcher */ "./src/switcher.js");
...
const initialEvents = new Array(5).fill(5).map(_data__WEBPACK_IMPORTED_MODULE_1__["pointData"]);
...
const renderTasks = events => {
  ...
  if (events !== null && !events.deleted) {
    ...
    Object(_switcher__WEBPACK_IMPORTED_MODULE_6__["switcher"])();
  }
};
...
const getEventsStats = () => {
  ...
  for (const it of _main__WEBPACK_IMPORTED_MODULE_2__["initialEvents"]) {
    eventsStats.data.push(Object(_utils__WEBPACK_IMPORTED_MODULE_3__["getTotalPrice"])(it.offers, it.price));
    eventsStats.labels.push(`${_data__WEBPACK_IMPORTED_MODULE_4__["travelToData"][it.type].text}${it.city} ${_data__WEBPACK_IMPORTED_MODULE_4__["travelToData"][it.type].icon}`);
  }
...
const getTransportStats = () => {
  ...
  for (const it of _data__WEBPACK_IMPORTED_MODULE_4__["transportType"]) {
    const sum = array.filter(elem => {
      return elem === it;
    }).length;
    transportStats.data.push(sum);
    transportStats.labels.push(`${_data__WEBPACK_IMPORTED_MODULE_4__["travelToData"][it].name} ${_data__WEBPACK_IMPORTED_MODULE_4__["travelToData"][it].icon}`);
  }
...
const showChart = () => {
  ...
  const transportStats = Object.assign({}, getTransportStats()); // moneyData, transportData, timeData
  ...
  const moneyChart = new chart_js__WEBPACK_IMPORTED_MODULE_0___default.a(moneyCtx, {
  ...
  const transportChart = new chart_js__WEBPACK_IMPORTED_MODULE_0___default.a(transportCtx, {
    plugins: [chartjs_plugin_datalabels__WEBPACK_IMPORTED_MODULE_1___default.a],
    type: `horizontalBar`,
    data: {
